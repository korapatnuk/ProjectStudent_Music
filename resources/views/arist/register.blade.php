    ...
    <div class="container">
        <main>
            <div class="py-5 text-center">
                <h2 class="fs-1 fw-bold is-font text-white">ลงทะเบียนวงดนตรี
                    </h2>
            </div>
            <form enctype="multipart/form-data" class="needs-validation" novalidate="" method="POST" action="{{ route('arist.store') }}">
                {{ csrf_field() }}
                <div class="row mb-3 p-3" style="background-color: rgba(255,255,255,.8)">
                    <div class="col-md-12 col-lg-8">
                        <h4 class="mb-3">ลงทะเบียนวงดนตรี</h4>
                        <div class="row g-3">

                            <div class="col-12">
                                <label for="aname" class="form-label">ชื่อวงดนตรี</label>
                                <div class="input-group has-validation">
                                    <input value="{{ old('aname') }}" name="aname" type="text" class="form-control"
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group has-validation">
                                    <textarea value="{{ old('details') }}" name="details" type="text" class="form-control"
                                        id="details" placeholder="รายละเอียด"></textarea>
